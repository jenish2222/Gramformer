...
setuptools.setup(
    ...
    install_requires=['transformers', 'sentencepiece', 'python-Levenshtein', 'fuzzywuzzy',  'tokenizers', 'fsspec'],
    dependency_links=['git+https://github.com/jenish2222/errant.git'],
    classifiers=[
